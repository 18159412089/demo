...
layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
    ...
    function lockPage() {
        layer.open({
            ...
            content: '	<div class="admin-header-lock" id="lock-box">' +
                '<div class="admin-header-lock-img"><img src="' + $('#headImg').attr("src") + '"/></div>' +
                '<div class="admin-header-lock-name" id="lockUserName">'+window.sessionStorage.username+'</div>' +
                '<div class="input_btn">' +
                '<input type="password" class="admin-header-lock-input layui-input" autocomplete="off" placeholder="锁屏密码与登录密码一致" name="lockPwd" id="lockPwd" />' +
    ...
    $("body").on("click", "#unlock", function () {
        if ($(this).siblings(".admin-header-lock-input").val() == '') {
            ...
            $.post("/admin/system/user/lockPassword", {
                "p": $(this).siblings(".admin-header-lock-input").val(),
            }, function (res) {
                if (res.success) {
