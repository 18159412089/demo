...
<fieldset class="layui-elem-field">
    ...
    <form class="layui-form">
        ...
        <@shiro.hasPermission name="system:logs:delete">
            <div class="layui-inline">
    ...
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            ...
            cols: [[
                ...
                {field:'createDate',width: '10%',title: '创建时间',templet:'<div>{{ layui.laytpl.toDateString(d.createDate) }}</div>',unresize: true}, //单元格内容水平居中
        ...
        var active={
            deleteSome : function(){                        //批量删除
                ...
                if(data.length > 0){
                    ...
                    layer.msg("请选择需要删除的日志",{icon: 7},{time:1000});;
                }
            },reset:function(){
