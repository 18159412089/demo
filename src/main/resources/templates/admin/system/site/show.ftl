...
<form class="layui-form">
    ...
    <table class="layui-table">
        ...
        <tr>
            <td>网站名称</td>
            <td><input type="text" class="layui-input cmsName" maxlength="255" name="name" value="${site.name}" lay-verify="required" placeholder="请输入网站名称"></td>
            <td>name</td>
        </tr>
        <tr>
            <td>网站地址</td>
            <td><input type="text" class="layui-input cmsName" maxlength="500" name="url" value="${site.url}" lay-verify="required" placeholder="请输入网站地址"></td>
            <td>url</td>
        </tr>
        <tr>
            <td>是否开放留言</td>
        ...
        <tr>
            <td>当前版本</td>
            <td><input type="text" class="layui-input version" maxlength="255" name="version" value="${site.version}" placeholder="请输入当前版本"></td>
            <td>version</td>
        </tr>
        <tr>
            <td>开发作者</td>
            <td><input type="text" class="layui-input author" maxlength="255" name="author" value="${site.author}" placeholder="请输入开发作者"></td>
            <td>author</td>
        </tr>
        <tr>
            <td>作者头像</td>
            <td>
                <input type="hidden" class="layui-input author" maxlength="255" name="authorIcon" value="${site.authorIcon}">
        ...
        <tr>
            <td>微博</td>
            <td><input type="text" class="layui-input author" maxlength="255" maxlength="255" maxlength="255" name="weibo" value="${site.weibo}" placeholder="请输入微博地址"></td>
            <td>weibo</td>
        </tr>
        <tr>
            <td>QQ</td>
            <td><input type="text" class="layui-input author" maxlength="255" maxlength="255" maxlength="255" name="qq" value="${site.qq}" placeholder="请输入QQ号"></td>
            <td>qq</td>
        </tr>
        <tr>
            <td>git</td>
            <td><input type="text" class="layui-input author" maxlength="255" maxlength="255" maxlength="255" name="git" value="${site.git}" placeholder="请输入码云地址"></td>
            <td>git</td>
        </tr>
        <tr>
            <td>github</td>
            <td><input type="text" class="layui-input author" maxlength="255" maxlength="255" name="github" value="${site.github}" placeholder="请输入github地址"></td>
            <td>github</td>
        </tr>
        <tr>
            <td>手机</td>
            <td><input type="number" class="layui-input homePage" maxlength="255" maxlength="255" name="phone" value="${site.phone}" lay-verify="phone" placeholder="请输入手机号码"></td>
            <td>phone</td>
        </tr>
        <tr>
            <td>邮箱</td>
            <td><input type="text" class="layui-input" name="email" maxlength="255" maxlength="255" value="${site.email}" lay-verify="email" placeholder="请输入邮箱"></td>
            <td>email</td>
        </tr>
        <tr>
            <td>地址</td>
            <td><input type="text" class="layui-input author" maxlength="255" maxlength="255" name="address" value="${site.address}" placeholder="请输入地址"></td>
            <td>address</td>
        </tr>
        <tr>
            <td>网站LOGO</td>
        ...
        <tr>
            <td>服务器环境</td>
            <td><input type="text" class="layui-input server layui-disabled" maxlength="255" name="server" disabled value="${site.server}" placeholder="请输入服务器环境"></td>
            <td>server</td>
        </tr>
        <tr>
            <td>数据库版本</td>
            <td><input type="text" class="layui-input dataBase layui-disabled" maxlength="255" name="database" disabled value="${site.database}" placeholder="请输入数据库版本"></td>
            <td>database</td>
        </tr>
        <tr>
            <td>最大上传限制</td>
        ...
        <tr>
            <td>默认关键字</td>
            <td><input type="text" class="layui-input keywords" name="keywords" maxlength="255" value="${site.keywords}" placeholder="请输入默认关键字"></td>
            <td>keywords</td>
        </tr>
        <tr>
            <td>网站描述</td>
            <td><textarea placeholder="请输入网站描述" name="description"  maxlength="255" class="layui-textarea description">${site.description}</textarea></td>
            <td>description</td>
        </tr>
        <tr>
            <td>版权信息</td>
            <td><input type="text" class="layui-input powerby" name="powerby" maxlength="255" value="${site.powerby}"  placeholder="请输入网站版权信息"></td>
            <td>powerby</td>
        </tr>
        <tr>
            <td>网站备案号</td>
            <td><input type="text" class="layui-input record" name="record" maxlength="255" value="${site.record}" placeholder="请输入网站备案号"></td>
            <td>record</td>
        </tr>
        <tr>
            <td>个人简介</td>
    ...
    layui.use(['form','layer','jquery','upload'], function(){
        ...
        form.on('submit(site)',function(data){
            ...
            $.post('${base}/admin/system/site/edit',data.field,function (res) {
               ...
               if(res.success){
                   layer.msg("站点信息更新成功",{icon: 1},function () {
                       location.reload();
                   });
