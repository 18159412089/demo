...
<form class="layui-form" wid100>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" maxlength="255" name="qiniuBasePath" value="${info.qiniuBasePath}" lay-verify="required" placeholder="请输入七牛Bucket 域名或者自有自有域名">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">Bucket目录<span class="layui-badge-dot"></span></label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" maxlength="255" name="qiniuBucketName" value="${info.qiniuBucketName}" lay-verify="required" placeholder="请输入七牛Bucket目录">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">存储目录</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" maxlength="255" name="qiniuDir" value="${info.qiniuDir}"  placeholder="请输入存储目录">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">ACCESS_KEY<span class="layui-badge-dot"></span></label>
        <div class="layui-input-block">
            <input type="password" class="layui-input" maxlength="255" name="qiniuAccessKey" value="${info.qiniuAccessKey}" lay-verify="required" placeholder="请输入七牛ACCESS_KEY">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">SECRET_KEY<span class="layui-badge-dot"></span></label>
        <div class="layui-input-block">
            <input type="password" class="layui-input" maxlength="255" name="qiniuSecretKey" value="${info.qiniuSecretKey}" lay-verify="required" placeholder="请输入七牛SECRET_KEY">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
            <@shiro.hasPermission name="sys:site:editQiniu">
        ...
        form.on("submit(addUser)",function(data){
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    if(res.success){
                        parent.layer.msg("七牛云信息更新成功!",{icon: 1,time:1000},function(){
                            //刷新父页面
