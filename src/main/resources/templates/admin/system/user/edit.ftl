...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="loginName" maxlength="36" lay-verify="required" placeholder="请输入登录名" value="${localuser.loginName}">
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-inline">
            ...
            <div class="layui-input-block">
                <input type="text" class="layui-input" maxlength="40" name="nickName" placeholder="请输入昵称" value="${localuser.nickName}">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">邮箱</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="email" maxlength="200" lay-verify="email" placeholder="请输入邮箱" value="${localuser.email}">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">手机</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="tel" maxlength="11" lay-verify="phone" placeholder="请输入手机号" value="${localuser.tel}">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
