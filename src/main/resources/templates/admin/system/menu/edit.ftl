...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="name" maxlength="40" lay-verify="required" value="${menu.name}" placeholder="请输入菜单名称">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="href" maxlength="2000" value="${menu.href}"  placeholder="请输入菜单地址">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">菜单权限</label>
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="permission" maxlength="255" value="${menu.permission}"  placeholder="请输入菜单授权标识，如sys:user:list">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        var treeSelect = layui.treeSelect;
            treeSelect.render({
                ...
                success: function (d) {
                    console.log(d);
//                选中节点，根据id筛选
                    treeSelect.checkNode('tree', '${menu.parentId!}'==''?null:'${menu.parentId}');
...
//                刷新树结构
        ...
        form.on("submit(addUser)",function(data){
            ...
            $.post("${base}/admin/system/menu/edit",data.field,function (res) {
                ...
                if(res.success){
                    parent.layer.msg("菜单编辑成功!",{icon: 1,time:1000},function(){
