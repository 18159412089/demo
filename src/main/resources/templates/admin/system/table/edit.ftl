...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <a class="layui-btn layui-btn-warm" id="addField">添加字段</a>
        </div>
    </div>
...
<div class="detail-body" id="fieldForm" style="display: none">
    <form class="layui-form" style="width:90%;" id="myform">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="number" class="layui-input" lay-verType="tips" name="length" id="fieldLength"
                       lay-verify="lengthCheck" placeholder="字段长度(不确认长度可以不填)">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">字段注释</label>
            <div class="layui-input-block">
                <input type="text" class="layui-input" name="comment" lay-verify="required" lay-verType="tips"
                       placeholder="请输入字段注释">
            </div>
        </div>
        <div class="layui-form-item">
