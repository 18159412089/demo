...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            ...
            <button  class="layui-btn layui-btn-normal" onclick="parent.layer.closeAll()">取消</button>
    ...
    <form class="layui-form" style="width:90%;" id="myform">
        ...
        <div class="layui-form-item" style="text-align: center">
            <div class="layui-input-block" >
                ...
                <#--<button class="layui-btn layui-btn-normal" onclick="layer.close(this)">取消</button>-->
            </div>
        </div>
    <form>
</div>
        ...
        form.on("submit(addUser)",function(data){
            ...
            $.ajax({
                ...
                success:function(res){
                    ...
                    if(res.success){
                        parent.layer.msg("数据表新增成功!",{icon: 1,time:1000},function(){
                            //刷新父页面
