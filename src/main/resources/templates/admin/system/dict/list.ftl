...
<div class="layui-form users_list">
    ...
    <script type="text/html" id="barDemo">
        ...
        <@shiro.hasPermission name="sys:dict:editType">
    ...
    layui.use(['layer','form','table'], function() {
        ...
        t = {
            ...
            cols: [[
                ...
                {field:'updateDate',  title: '修改时间',width:'10%',templet:'<div>{{ layui.laytpl.toDateString(d.updateDate) }}</div>',unresize: true}, //单元格内容水平居中
