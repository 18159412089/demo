...
<form class="layui-form" style="width:80%;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input  type="text"  class="layui-input layui-disabled" disabled value="${parentChannel.name}">
        </div>
    </div>
    <input type="hidden" name="parentId" value="${parentChannel.id}">
    </#if>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="hidden" class="layui-input" name="logo" id="iconValue"  placeholder="请选择菜单图标">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <#if (parentChannel.href)??>
                <div class="layui-input-inline" style="width: 50%;margin-right: 0">
                    <input type="text" name="preHref" value="${parentChannel.href+'/'}" disabled   class="layui-input layui-disabled pre-href" >
                </div>
                <div class="layui-input-inline" style="width: 50%;margin-right: 0">
                    <input type="text" name="href"  class="layui-input href" lay-verify="required|blogHref" lay-verType="tips">
                </div>
            <#else>
                <input  type="text"  class="layui-input href"  name="href"  lay-verify="required|blogHref" lay-verType="tips">
            </#if>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="baseChannel"  lay-skin="switch" value="1" lay-text="是|否" >
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" name="canComment"  lay-skin="switch" value="1" lay-text="是|否" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" name="noName"  lay-skin="switch" value="1" lay-text="是|否" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input type="checkbox" name="canAduit"  lay-skin="switch" value="1" lay-text="是|否" >
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="seoTitle"  placeholder="请输入网页title(seo)">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <input  type="text"  class="layui-input" name="seoKeywords"  placeholder="请输入网页关键字(seo) ">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            ...
            <textarea name="seoDescription"  placeholder="请输入网页描述(seo)" class="layui-textarea"></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <div class="layui-input-block">
    ...
    layui.use(['form','jquery','layer'],function(){
        ...
        form.on("submit(addBlogChannel)",function(data){
            ...
            $.post("${base}/admin/blogChannel/add",data.field,function(res){
                ...
                if(res.success){
                    parent.layer.msg("文章栏目添加成功！",{icon: 1,time:1000},function(){
