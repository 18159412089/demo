...
<script>
    ...
    layui.use(['form','jquery','layer','treeSelect'],function(){
        ...
        treeSelect.render({
            ...
            elem: '#tree',
            // 数据
            data: '/admin/blogArticle/channelTree',
            ...
            success: function (d) {
                ...
                console.log(d);
//                选中节点，根据id筛选
                treeSelect.checkNode('tree', '${blogChannel.parentId!}' == '' ? null : '${blogChannel.parentId!}');
...
//                刷新树结构
        ...
        form.on("submit(addBlogChannel)",function(data){
            ...
            $.post("${base}/admin/blogChannel/edit",data.field,function(res){
                ...
                if(res.success){
                    parent.layer.msg("文章栏目编辑成功！",{icon: 1,time:1000},function(){
