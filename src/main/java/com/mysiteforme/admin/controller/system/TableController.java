...
import com.mysiteforme.admin.util.CreateTableFiles;
import com.mysiteforme.admin.util.LayerData;
import com.mysiteforme.admin.util.RestResponse;
import com.mysiteforme.admin.util.ZipUtil;
...
public class TableController extends BaseController {
    ...
    public LayerData<TableField> fieldlist(@RequestParam(value = "page", defaultValue = "1") Integer page,
        ...
        if (!map.isEmpty()) {
            ...
            if (!"1".equals(tableType) && !"2".equals(tableType) && !"3".equals(tableType)) {
