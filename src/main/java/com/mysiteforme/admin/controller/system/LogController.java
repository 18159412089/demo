...
/**
 * Created by huangyl on 2018/1/13.
 * todo:
 */
@Controller
...
public class LogController extends BaseController {
     ...
     * @Author huangyl
     */
    @PostMapping("visitPlaceDistribution")
    @ResponseBody
    public List visitPlaceDistribution() {
        return logService.visitPlaceDistribution();
    }
