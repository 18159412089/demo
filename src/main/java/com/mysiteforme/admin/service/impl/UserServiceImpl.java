...
public class UserServiceImpl extends ServiceImpl<UserDao, User> implements UserService {
    ...
    @Caching(evict = {
            ...
            @CacheEvict(value = "roleAll", allEntries = true),
            @CacheEvict(value = "commentData", allEntries = true),
            @CacheEvict(value = "uploadInfoCache", allEntries = true),
            @CacheEvict(value = "showBlog", allEntries = true),
            @CacheEvict(value = "currentSite",allEntries = true)
    })
    @Override
